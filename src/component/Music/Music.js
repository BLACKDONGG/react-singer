            ...
            musicList: [
                {
                    name: "晴天",
                    singer: "刘瑞琦",
                    cover: "https://www.ditto.ink/music/jay.jpg",
                    src: "https://www.ditto.ink/music/qingtian.mp3"
                },
                {
                    name: "慢慢喜欢你",
                    singer: "莫文蔚",
                    cover: "https://www.ditto.ink/music/mowenwei.jpg",
                    ...
                    <div className={this.state.musicWrapperControl ? "music-wrapper music-wrapper-on":"music-wrapper music-wrapper-off"}>
                        ...
                        <div className="music-drawer">
                            ...
                            <div className="music-reaction">
                                ...
                                <div className="music-song music-previous-list icon-next" onClick={this.getNextSongList}></div>
                            </div>
                        </div>
                    </div>
